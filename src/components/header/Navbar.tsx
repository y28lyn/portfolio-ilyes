    ...
    >
      ...
      >
        ...
        <div className="flex flex-row font-medium md:py-1 md:mt-1 md:border-0 md:order-2 md:text-[11px] -ml-6">
          <p className="text-white md:block hidden">07 78 90 74 44</p>
          ...
          {menuOpen && (
            ...
            >
              <ul className="flex flex-col font-medium bg-transpaent text-white rounded shadow-sm -mt-4">
                ...
                <li>
                  <p className="block py-2 pl-3 pr-4">07 78 90 74 44</p>
                </li>
        ...
        <div
          ...
          id="navbar-sticky"
        >
          <ul className="text-[11px] flex flex-row p-4 md:p-0 mt-4 font-medium md:space-x-4 md:mt-1 md:border-0">
            <li>
              <Link
                to="/"
