            ...
            {timelineEvents.map((event, index) => {
              return (
                <li className="relative" key={index}>
                  <div className="bg-slate-800 rounded-full h-12 w-12 absolute left-1/2 transform -translate-x-1/2 -translate-y-1/2" />
                  <div className="grid grid-cols-1 grid-rows-1 space-x-4 md:space-x-6 lg:space-x-8 justify-items-center items-center">
                    <div className="mb-8 mt-12 p-6 rounded-xl bg-[#000302] border-2 border-slate-800 ">
