          ...
          <div className="grid items-center grid-cols-1 md:grid-cols-2">
            <div>
              ...
              <p className="max-w-lg mt-3 text-xl leading-relaxed text-gray-800 dark:text-gray-200 md:mt-8">
                Volontaire en service civique à l'AFEV, titulaire d'un BTS SIO
                option SLAM, passionné par le développement web avec React,
                TypeScript, et Tailwind CSS, et un intérêt pour le PHP ainsi que
                le C#.
              </p>

              <p className="mt-4 text-xl text-gray-800 dark:text-gray-200 md:mt-8">
                <span className="relative inline-block">
                  <span className="absolute inline-block w-full bottom-0.5 h-2 bg-blue-300 dark:bg-blue-700"></span>
